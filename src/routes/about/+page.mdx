...
<div class="min-h-screen w-screen max-w-screen px-0 m-0 bg-[#110033] overflow-x-clip overscroll-x-none" style="font-family: Inter">
    <header class="mx-auto flex items-center text-white lg:max-w-screen-xl md:w-2/5 w-4/5 overscroll-x-none">
        <div class="text-left mt-20 w-full">
            <h1 class="text-xl my-0">{date}</h1>
    ...
    <div class="prose text-lg text-white w-3/4 md:w-2/5 mx-auto font-500 pb-10 overflow-x-clip overscroll-x-none">
        ...
        <img src="about.webp" class="object-center h-auto max-w-full rounded-xl" alt="team illusion photo">
